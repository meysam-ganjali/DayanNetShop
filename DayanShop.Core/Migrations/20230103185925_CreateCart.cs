        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChildTitle = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ChildTitleSlug = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowDiscountLable = table.Column<bool>(type: "bit", nullable: false),
                    Percentage = table.Column<int>(type: "int", nullable: true),
                    ChildCategoryId = table.Column<int>(type: "int", nullable: false),
                    ProductSpecial = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltAttr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TitleAttr = table.Column<string>(type: "nvarchar(max)", nullable: true),
